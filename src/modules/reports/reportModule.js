...
const reportTypes = ['Monthly Register Member', 'All Member Register'];
const supportedReportTypes = ['Monthly Register Member', 'All Member Register'];
  ...
  if (type === 'Monthly Register Member') {
    return (data.members || [])
      ...
      .map((member) => ({
        ...
        approver: member.approvingAuthority || member.approvedBy || member.verifiedBy || '',
