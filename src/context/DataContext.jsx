...
function memberRowToAppMember(row = {}) {
  return {
    ...
    lastContributionDate: row.last_contribution_date ?? row.membership_date ?? row.created_at?.slice?.(0, 10) ?? '',
    membershipDate: row.last_contribution_date ?? row.membership_date ?? row.created_at?.slice?.(0, 10) ?? '',
